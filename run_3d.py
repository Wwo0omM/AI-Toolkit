...
# 2. Путь к картинке
input_image = r"C:\Program Files\Blender Foundation\Blender 5.1\5.1\scripts\addons_core\ai_toolkit\pepe.jpg"        # менять путь
...
try:
    ...
    if model_path:
        ...
        final_dest = os.path.join(desktop, "pepe_model.glb")                            # менять название
